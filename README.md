...
This transformation allows analytical derivation of confidence bounds on the Remaining Useful Life RUL in $t'$, which can be transformed into non-linear RUL bounds in the original time: 
